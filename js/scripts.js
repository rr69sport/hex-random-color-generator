...
const createHexColor = (hexValues) => {
  ...
  const complementaryValues = {
    red: getOppositePosition(hexValues, getColorIndex.red),
    green: getOppositePosition(hexValues, getColorIndex.green),
    blue: getOppositePosition(hexValues, getColorIndex.blue)
  }
